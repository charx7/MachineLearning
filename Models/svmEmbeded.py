...
if __name__ == '__main__':
    ...
    print('Joining data...')
    rnd_st = 42
    df = joinData(botData.sample(5000, random_state=rnd_st), genuineData.sample(5000, random_state=rnd_st))
    ...
    val_tweets_w2v = embed_Dataframe(X_val, '../Preprocess/tf_saved_models\\word_emb')
    ...
    # Model dump
    joblib.dump(best_params['bestModel'],'../Trained_Models/svm_own_w2v_model')
