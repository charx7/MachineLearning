...
* The complete spambot and genuine tweet .csv files, used in the decision trees, should be placed in the path "data//datasets_full.csv/traditional_spambots_1.csv/" and "data/datasets_full.csv/genuine_accounts.csv/".
